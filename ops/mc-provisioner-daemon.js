...
const REPO_ROOT = process.env.AGENT_CONTROL_ROOM_REPO_ROOT || path.resolve(__dirname, '..')
const DATA_DIR = process.env.AGENT_CONTROL_ROOM_DATA_DIR || path.join(REPO_ROOT, '.data')
